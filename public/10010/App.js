...
(function() {
     ...
     * 是否为通过网页访问
     * true：当前是通过浏览器访问；
     * false：当前是通过非浏览器（如android、iphone、wechat等）访问；
     */
    // App.isWeb = App.versionType != 'android' && App.versionType != 'iphone'
    //         && App.versionType != 'ap' && App.versionType != 'wx';
    App.isWeb = window.navigator.appVersion.indexOf('unicom') === -1 ? true : false;
...
function url(){
    ...
    var $img = $('.title_ul').find('img').eq(0).length === 0 ? 
        $('.title_p').find('img').eq(0) : $('.title_ul').find('img').eq(0);
   
    if(url.indexOf("http://demo.mall.10010.com:8104/jf-mall/mobileIndex")==0||url=="https://m.jf.10010.com"){
        //首页
        return (function(shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath){
            return {
                shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath
            }
          })($(document).attr("title"),"url","中国联通积分商城,积分兑换，优惠多多！","http://img.client.10010.com/mobileService/view/client/images/shareIcon.jpg",window.location.href,"","","","")
    }
        else if(url.indexOf("https://m.jf.10010.com/jf-mall/msearchPointNew")==0||url.indexOf("http://demo.mall.10010.com:8104/jf-mall/msearchPointNew")==0
        ||url.indexOf("https://m.jf.10010.com/jf-mall/msearchPKeyword")==0||url.indexOf("https://m.jf.10010.com/jf-mall/myPoint")==0
        ||url.indexOf("https://m.jf.10010.com/jf-mall/msearchClassify")==0){
        //商品列表页
        return (function(shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath){
            return {
                shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath
    ...
    }else if(url.indexOf("https://m.jf.10010.com/jf-nps/woscore/m/index.do")==0
            ||url.indexOf("http://demo.mall.10010.com:8104/jf-nps/woscore/m/index.do")==0){
        //赚取积分页
        return (function(shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath){
            return {
                shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath
    ...
    }else if(url.indexOf("https://m.jf.10010.com/jf-static/m/jfMerge.html")==0
            ||url.indexOf("http://demo.mall.10010.com:8104/jf-static/m/jfMerge.html")==0){
            //积分直充
        return (function(shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath){
            return {
                shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath
    ...
    else  if(url.indexOf("https://m.jf.10010.com/jf-static/m")==0
            ||url.indexOf("http://demo.mall.10010.com:8104/jf-static/m")==0){
        //爱心捐赠页
        return (function(shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath){
            return {
                shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath
    ...
    }else if(url.indexOf("http://demo.mall.10010.com:8104/jf-mall/mobSecondRanking/all")==0
            ||url.indexOf("https://m.jf.10010.com/jf-mall/mobSecondRanking/all")==0){
        //热兑排行
        return (function(shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath){
            return {
                shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath
...
else if(url.indexOf('https://m.jf.10010.com/jf-mall/mspgoods')==0||url.indexOf('https://m.jf.10010.com/item')==0||
url.indexOf('http://demo.mall.10010.com:8104/jf-mall/mspgoods')==0||url.indexOf('http://demo.mall.10010.com:8104/item')==0){
         //商品详情页
        return (function(shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath){
            return {
                shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath
            }
          })($('.goods_name').text() ,"url",$('.goods_name').text() ,$img.prop('src'),window.location.href,"","","","")
    } else if(url.indexOf("https://m.jf.10010.com/m/fs/active")==0){
        // 专题活动
        return (function(shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath){
            return {
                shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath
    ...
    }else if(url.indexOf('https://m.jf.10010.com/cms/jf-res/mobile/html/fourth_index_more.html')==0){
        // 积分服务
        return (function(shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath){
            return {
                shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath
    ...
    else if(url.indexOf('https://m.jf.10010.com/jf-order')==0){
        // 个人中心
        return (function(shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath){
            return {
                shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath
    ...
    else if(url.indexOf('https://m.jf.10010.com/jf-mall/Mnotice')==0||url.indexOf('http://demo.mall.10010.com:8104/jf-mall//Mnotice')==0){
        // 商城公告
        return (function(shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath){
            return {
                shareTitle,shareType,shareContent,shareIconURL,shareURL,miniProgramShare,miniProgramType,miniProgramUserName,miniProgramPath
...
function getMenuConfig_Local(){
    var getMenuConfig = {"config":[ 
        {   "code":"fenxiang",
            "title":"分享",
            "shareList":"sinaweibo,tencentweibo,qzone,wechat,wechatmoments,email,shortmessage,qq",
            "shareJson":url()
        },
        // {
        //     "code":"jietufenxiang",
        ...
        //     "shareList":"sinaweibo,tencentweibo,qzone,wechat,wechatmoments,email,shortmessage,qq",
        //     "shareJson":
        //         {"shareContent":"分享内容","shareIconURL":"分享图片链接（可为空）","shareTitle":"分享标题（可为空）","shareType":"分享类型（可为空）","shareURL":"分享连接（可为空）","shareQrcodeURL":"分享二维码图片"},
        //         "desc":"分享测试描述"
        // },
        { 
            "code":"tucao", 
    ...
    return  JSON.stringify(getMenuConfig);
}