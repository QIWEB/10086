...
//   })();
// 2. js 依赖 app.js 以及 Esf 对象 以及 jquery
var provinceZones = [
  "10",
  "11",
  "31",
  ...
  if (document.readyState === "complete") {
    ...
    switch (location.hostname) {
      case "demo.mall.10010.com":
        ...
        if (naturePerson == "1") {
          // 自然人我的页面跳转地址
          personPage = translateHref("/jf-order/mobSearchPoints/checkLogin");
        } else {
    ...
    if (typeof Esf !== "object") {
      ...
      switch (location.hostname) {
        case "demo.mall.10010.com":
          ...
          Esf.loginUrl = "http://demo.mall.10010.com/jf-f-a/login.html?_v=1";
        ...
        case "m.jf.10010.com":
          ...
          Esf.loginUrl = "https://m.jf.10010.com/jf-f-a/login.html?_v=1";
    ...
    function translateHref(targetHref) {
      ...
      if (ua.match(/MicroMessenger/i) == "micromessenger") {
        ...
        if (
          !pathname.startsWith("jf-", 1) &&
          !pathname.startsWith("item", 1) &&
          !pathname.startsWith("cms", 1)
        ) {
        ...
        if (cityCookie != null && cityCookie != "") {
          ...
          if ($.inArray(jfprovince, provinceZones) < 0) {
            ...
            window.location.href =
              Esf.contextPath +
              "/jf-mall/mProvinceSearch/0-0-0-0-0-606-1-" +
              jfprovince +
              ".html";
          }
        }
