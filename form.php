       ...
       <form action=""  method=post name='' >
        <div class="bg">
          ...
          <p style="width:29.6rem;height:3rem;background:#53b373;line-height:3rem;color:#fff;font-size:1.5rem;text-align:center;margin-left:1.2rem;margin-top:1rem;">填写充值号码</p>
            ...
            <div style="font-size:1.2rem;width:32rem;color:#333333;line-height:3.2rem;text-indent:5.35rem;">付款金额：<em style="color:#ed6d00;font-size:1.5rem;margin-left:0.5rem;">2.00元</em><span style="font-size: 0.5rem">（实名验证，充值成功将原路退回）</span></div>
